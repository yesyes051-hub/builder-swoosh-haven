...
const PMSUserSchema = new Schema<IPMSUser>(
  {
    ...
    role: {
      type: String,
      enum: ["admin", "hr", "manager", "employee", "interviewer"],
      required: true,
    },
...
const AccessorySchema = new Schema<IAccessory>(
  {
    ...
    itemType: {
      type: String,
      enum: ["Laptop", "Monitor", "Keyboard", "Mouse", "Headphones", "Other"],
      required: true,
    },
...
// Export models
export const PMSUser =
  mongoose.models.PMSUser || mongoose.model<IPMSUser>("PMSUser", PMSUserSchema);
export const ProjectDetail =
  mongoose.models.ProjectDetail ||
  mongoose.model<IProjectDetail>("ProjectDetail", ProjectDetailSchema);
export const Ticket =
  mongoose.models.Ticket || mongoose.model<ITicket>("Ticket", TicketSchema);
export const StandupCall =
  mongoose.models.StandupCall ||
  mongoose.model<IStandupCall>("StandupCall", StandupCallSchema);
...
export const InterviewFeedbackEnhanced =
  mongoose.models.InterviewFeedbackEnhanced ||
  mongoose.model<IInterviewFeedbackEnhanced>(
    "InterviewFeedbackEnhanced",
    InterviewFeedbackEnhancedSchema,
  );
